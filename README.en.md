<div style="text-align: center; margin-bottom: 20px;">
  <a href="README.en.md" style="padding: 8px 16px; background-color: #4CAF50; color: white; text-decoration: none; border-radius: 4px; margin-right: 20px;">English</a>
...
How to Add bookmark on your PDF document by AI?

A powerful and user-friendly PDF processing tool that provides table of contents extraction, content analysis, and other features to help you handle PDF documents more efficiently.
...
- Prepare a JSON format table of contents file (refer to docs/toc_example.json for format)
...
- Select the page range to analyze
- Click "Tools" > "Content Analysis"
...
- Ensure you have correctly configured the OpenAI API key
